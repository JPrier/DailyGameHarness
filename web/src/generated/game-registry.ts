...
import GameView_2 from '../../../.harness/external-games/DailyGameFlagFade/src/GameView.svelte';
import { createRuntime as createRuntime_2 } from '../../../.harness/external-games/DailyGameFlagFade/dist/runtime/index.js';
import GameView_3 from '../../../fixtures/games/command-build-game/src/GameView.svelte';
import { createRuntime as createRuntime_3 } from '../../../fixtures/games/command-build-game/dist/runtime/index.js';
import GameView_4 from '../../../.harness/external-games/DailyGameCityGrid/src/GameView.svelte';
import { createRuntime as createRuntime_4 } from '../../../.harness/external-games/DailyGameCityGrid/dist/runtime/index.js';
...
export const generatedGameRegistry = {
  ...
  "flag-fade": { id: "flag-fade", slug: "flag-fade", displayName: "Flag Fade", category: "geography", routePrefix: "", contentManifestUrl: "/_games/flag-fade/content/manifest.json", dateIndexUrl: null, puzzleBaseUrl: "/_games/flag-fade/content/puzzles", assetBaseUrl: "/_games/flag-fade/content/assets", runtimeAssetBaseUrl: "/_games/flag-fade/runtime", GameView: GameView_2, createRuntime: createRuntime_2, dates: [] },
  "command-build-game": { id: "command-build-game", slug: "command-build-game", displayName: "Command Build Game", category: "fixture", routePrefix: "", contentManifestUrl: "/_games/command-build-game/content/manifest.json", dateIndexUrl: null, puzzleBaseUrl: "/_games/command-build-game/content/puzzles", assetBaseUrl: "/_games/command-build-game/content/assets", runtimeAssetBaseUrl: "/_games/command-build-game/runtime", GameView: GameView_3, createRuntime: createRuntime_3, dates: [] },
  "city-grid": { id: "city-grid", slug: "city-grid", displayName: "City Grid", category: "geography", routePrefix: "", contentManifestUrl: "/_games/city-grid/content/manifest.json", dateIndexUrl: null, puzzleBaseUrl: "/_games/city-grid/content/puzzles", assetBaseUrl: "/_games/city-grid/content/assets", runtimeAssetBaseUrl: "/_games/city-grid/runtime", GameView: GameView_4, createRuntime: createRuntime_4, dates: [] },
} as const;
